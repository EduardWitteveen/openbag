 ...
 */
            ...
            /**
            *  DirectPositionListType bean class
            */
        
        public  class DirectPositionListType extends net.opengis.www.gml.DoubleList
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DirectPositionListType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (! namespace.equals("")) {
                    ...
                    xmlWriter.writeStartElement(localName);
                       ...
                       xmlWriter.writeCharacters(DirectPositionListType.this.toString());
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.opengis.net/gml","DirectPositionListType"));
    ...
    public static class Factory{
            ...
            public static DirectPositionListType fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content)
                                                                    throws org.apache.axis2.databinding.ADBException {

                DirectPositionListType object = new DirectPositionListType();
                ...
                try {
                    for (int i = 0; i < values.length; i++) {
                           ...
                           objectValues[i] =
                              org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(values[i]);
                          

                    }
                    object.set_double(objectValues);
                    return object;
        ...
        */
        public static DirectPositionListType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DirectPositionListType object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DirectPositionListType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DirectPositionListType)nl.vrom.www.bag.stuf._0120.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    object = DirectPositionListType.Factory.fromString(reader,content);
