 ...
 */
            ...
            /**
            *  LocationPropertyType bean class
            */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for LocationPropertyTypeChoice_type0
                        */

                        
                                    protected net.opengis.www.gml.LocationPropertyTypeChoice_type0 localLocationPropertyTypeChoice_type0 ;
                                

                           /**
                           * Auto generated getter method
                           * @return net.opengis.www.gml.LocationPropertyTypeChoice_type0
                           */
                           public  net.opengis.www.gml.LocationPropertyTypeChoice_type0 getLocationPropertyTypeChoice_type0(){
                               return localLocationPropertyTypeChoice_type0;
                           }
                            ...
                            /**
                               ...
                               * @param param LocationPropertyTypeChoice_type0
                               */
                               public void setLocationPropertyTypeChoice_type0(net.opengis.www.gml.LocationPropertyTypeChoice_type0 param){
                            
                                            this.localLocationPropertyTypeChoice_type0=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       LocationPropertyType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LocationPropertyType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                    ...
                                    if (localActuate != null){
                                        writeAttribute("http://www.w3.org/1999/xlink",
                                           ...
                                           localActuate.toString(), xmlWriter);
                                            ...
                                            if (localLocationPropertyTypeChoice_type0==null){
                                                 throw new org.apache.axis2.databinding.ADBException("LocationPropertyTypeChoice_type0 cannot be null!!");
                                            }
                                           localLocationPropertyTypeChoice_type0.serialize(null,factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.opengis.net/gml",
                                    ...
                                    elementList.add(localLocationPropertyTypeChoice_type0);
    ...
    public static class Factory{
        ...
        */
        public static LocationPropertyType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LocationPropertyType object =
                new LocationPropertyType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LocationPropertyType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LocationPropertyType)nl.vrom.www.bag.stuf._0120.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribRemoteSchema!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() ){
                                                ...
                                                object.setLocationPropertyTypeChoice_type0(net.opengis.www.gml.LocationPropertyTypeChoice_type0.Factory.parse(reader));
