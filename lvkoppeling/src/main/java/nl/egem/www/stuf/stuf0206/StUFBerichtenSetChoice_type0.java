...
/**
 * StUFBerichtenSetChoice_type0.java
 *
 ...
 */
            ...
            /**
            *  StUFBerichtenSetChoice_type0 bean class
            */
        
        public  class StUFBerichtenSetChoice_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = StUF-berichtenSetChoice_type0
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            private void clearAllSettingTrackers() {
                   ...
                   localSynchronisatieBerichtTracker = false;
                   ...
                   localFoutBerichtTracker = false;
                        ...
                        */
                        ...
                        /**
                        * field for SynchronisatieBericht
                        */

                        
                                    protected java.lang.Object localSynchronisatieBericht ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSynchronisatieBerichtTracker = false ;
                           ...
                           * @return java.lang.Object
                           */
                           public  java.lang.Object getSynchronisatieBericht(){
                               return localSynchronisatieBericht;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param SynchronisatieBericht
                               */
                               public void setSynchronisatieBericht(java.lang.Object param){
                            
                                clearAllSettingTrackers();
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localSynchronisatieBerichtTracker = true;
                                       } else {
                                          localSynchronisatieBerichtTracker = false;
                                              
                                       }
                                   
                                            this.localSynchronisatieBericht=param;
                        ...
                        */
                                    ...
                                    protected nl.egem.www.stuf.stuf0206.FoutBericht_type0 localFoutBericht ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return nl.egem.www.stuf.stuf0206.FoutBericht_type0
                           */
                           public  nl.egem.www.stuf.stuf0206.FoutBericht_type0 getFoutBericht(){
                            ...
                            /**
                               ...
                               */
                               public void setFoutBericht(nl.egem.www.stuf.stuf0206.FoutBericht_type0 param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       StUFBerichtenSetChoice_type0.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StUF-berichtenSetChoice_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StUF-berichtenSetChoice_type0",
                           xmlWriter);
                   }
                ...
                if (localKennisgevingsBerichtTracker){
                            ...
                            if (localKennisgevingsBericht!=null){
                                if (localKennisgevingsBericht instanceof org.apache.axis2.databinding.ADBBean){
                                    ((org.apache.axis2.databinding.ADBBean)localKennisgevingsBericht).serialize(
                                               new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","kennisgevingsBericht"),
                                               factory,xmlWriter,true);
                                 } else {
                                    java.lang.String namespace2 = "http://www.egem.nl/StUF/StUF0206";
                            ...
                            if (localVraagBericht!=null){
                                if (localVraagBericht instanceof org.apache.axis2.databinding.ADBBean){
                                    ((org.apache.axis2.databinding.ADBBean)localVraagBericht).serialize(
                                               new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","vraagBericht"),
                                               factory,xmlWriter,true);
                                 } else {
                                    java.lang.String namespace2 = "http://www.egem.nl/StUF/StUF0206";
                                    if (! namespace2.equals("")) {
                            ...
                            if (localAsynchroonAntwoordBericht!=null){
                                if (localAsynchroonAntwoordBericht instanceof org.apache.axis2.databinding.ADBBean){
                                    ((org.apache.axis2.databinding.ADBBean)localAsynchroonAntwoordBericht).serialize(
                                               new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","asynchroonAntwoordBericht"),
                                               factory,xmlWriter,true);
                                 } else {
                                    java.lang.String namespace2 = "http://www.egem.nl/StUF/StUF0206";
                                    if (! namespace2.equals("")) {
                        ...
                        } if (localSynchronisatieBerichtTracker){
                            
                            if (localSynchronisatieBericht!=null){
                                if (localSynchronisatieBericht instanceof org.apache.axis2.databinding.ADBBean){
                                    ((org.apache.axis2.databinding.ADBBean)localSynchronisatieBericht).serialize(
                                               new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","synchronisatieBericht"),
                                               factory,xmlWriter,true);
                                 } else {
                                    java.lang.String namespace2 = "http://www.egem.nl/StUF/StUF0206";
                                    if (! namespace2.equals("")) {
                                        ...
                                        if (prefix2 == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix2,"synchronisatieBericht", namespace2);
                                            xmlWriter.writeNamespace(prefix2, namespace2);
                                            xmlWriter.setPrefix(prefix2, namespace2);

                                        } else {
                                            xmlWriter.writeStartElement(namespace2,"synchronisatieBericht");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("synchronisatieBericht");
                                    }
                                    org.apache.axis2.databinding.utils.ConverterUtil.serializeAnyType(localSynchronisatieBericht, xmlWriter);
                                    xmlWriter.writeEndElement();
                                 }
                            } else {
                                
                                         throw new org.apache.axis2.databinding.ADBException("synchronisatieBericht cannot be null!!");
                                           ...
                                           localFoutBericht.serialize(new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","foutBericht"),
                                               factory,xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localKennisgevingsBerichtTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206",
                                    ...
                                    elementList.add(localSynchronisatieBericht);
                                } if (localFoutBerichtTracker){
                            elementList.add(new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206",
                                                                      "foutBericht"));
    ...
    public static class Factory{
        ...
        */
        public static StUFBerichtenSetChoice_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StUFBerichtenSetChoice_type0 object =
                new StUFBerichtenSetChoice_type0();
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","kennisgevingsBericht").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","vraagBericht").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","asynchroonAntwoordBericht").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","synchronisatieBericht").equals(reader.getName())){
                                
                                     object.setSynchronisatieBericht(org.apache.axis2.databinding.utils.ConverterUtil.getAnyTypeObject(reader,
                                                nl.vrom.www.bag.stuf._0120.ExtensionMapper.class));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0206","foutBericht").equals(reader.getName())){
                                
                                                object.setFoutBericht(nl.egem.www.stuf.stuf0206.FoutBericht_type0.Factory.parse(reader));
