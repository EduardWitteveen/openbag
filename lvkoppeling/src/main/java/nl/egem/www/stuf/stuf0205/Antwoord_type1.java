 ...
 */
            ...
            /**
            *  Antwoord_type1 bean class
            */
        
        public  class Antwoord_type1
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected nl.egem.www.stuf.stuf0205.RefNummerE localCrossRefNummer ;
                           ...
                           */
                           public  nl.egem.www.stuf.stuf0205.RefNummerE getCrossRefNummer(){
                            ...
                            /**
                               ...
                               */
                               public void setCrossRefNummer(nl.egem.www.stuf.stuf0205.RefNummerE param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Antwoord_type1.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":antwoord_type1",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "antwoord_type1",
    ...
    public static class Factory{
        ...
        */
        public static Antwoord_type1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Antwoord_type1 object =
                new Antwoord_type1();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"antwoord_type1".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Antwoord_type1)nl.vrom.www.bag.stuf._0120.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.egem.nl/StUF/StUF0205","crossRefNummer").equals(reader.getName())){
                                                ...
                                                object.setCrossRefNummer(nl.egem.www.stuf.stuf0205.RefNummerE.Factory.parse(reader));
