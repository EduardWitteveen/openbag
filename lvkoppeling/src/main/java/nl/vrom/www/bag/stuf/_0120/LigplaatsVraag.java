 ...
 */
            ...
            /**
            *  LigplaatsVraag bean class
            */
        
        public  class LigplaatsVraag extends nl.vrom.www.bag.stuf._0120.BagObjectVraag
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for LigplaatsGeometrie
                        */

                        
                                    protected nl.vrom.www.bag._0120.GeometrieVlak localLigplaatsGeometrie ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localLigplaatsGeometrieTracker = false ;
                           ...
                           */
                           public  nl.vrom.www.bag._0120.GeometrieVlak getLigplaatsGeometrie(){
                               return localLigplaatsGeometrie;
                           }
                            ...
                            /**
                               ...
                               * @param param LigplaatsGeometrie
                               */
                               public void setLigplaatsGeometrie(nl.vrom.www.bag._0120.GeometrieVlak param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localLigplaatsGeometrieTracker = true;
                                       } else {
                                          localLigplaatsGeometrieTracker = true;
                                              
                                       }
                                   
                                            this.localLigplaatsGeometrie=param;
                        ...
                        /**
                        * field for LigplaatsStatus
                        */

                        
                                    protected nl.vrom.www.bag.stuf._0120.LigplaatsStatus_type0 localLigplaatsStatus ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localLigplaatsStatusTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return nl.vrom.www.bag.stuf._0120.LigplaatsStatus_type0
                           */
                           public  nl.vrom.www.bag.stuf._0120.LigplaatsStatus_type0 getLigplaatsStatus(){
                               return localLigplaatsStatus;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param LigplaatsStatus
                               */
                               public void setLigplaatsStatus(nl.vrom.www.bag.stuf._0120.LigplaatsStatus_type0 param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localLigplaatsStatusTracker = true;
                                       } else {
                                          localLigplaatsStatusTracker = true;
                                              
                                       }
                                   
                                            this.localLigplaatsStatus=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       LigplaatsVraag.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LigplaatsVraag",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "LigplaatsVraag",
                           xmlWriter);
                                ...
                                } if (localLigplaatsGeometrieTracker){
                                    if (localLigplaatsGeometrie==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"ligplaatsGeometrie", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"ligplaatsGeometrie");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("ligplaatsGeometrie");
                                        }
                                     ...
                                     localLigplaatsGeometrie.serialize(new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120","ligplaatsGeometrie"),
                                        factory,xmlWriter);
                                    }
                                } if (localLigplaatsStatusTracker){
                                    if (localLigplaatsStatus==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"ligplaatsStatus", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"ligplaatsStatus");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("ligplaatsStatus");
                                        }
                                     ...
                                     localLigplaatsStatus.serialize(new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120","ligplaatsStatus"),
                                        factory,xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120","LigplaatsVraag"));
                 if (localIdentificatieTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120",
                                    ...
                                    elementList.add(localLigplaatsGeometrie==null?null:
                                    localLigplaatsGeometrie);
                                } if (localLigplaatsStatusTracker){
                            elementList.add(new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120",
                                                                      "ligplaatsStatus"));
                            
                            
                                    elementList.add(localLigplaatsStatus==null?null:
                                    localLigplaatsStatus);
                                }
                            attribList.add(
    ...
    public static class Factory{
        ...
        */
        public static LigplaatsVraag parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LigplaatsVraag object =
                new LigplaatsVraag();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LigplaatsVraag".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LigplaatsVraag)nl.vrom.www.bag.stuf._0120.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribNoValue!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120","ligplaatsGeometrie").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setLigplaatsGeometrie(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setLigplaatsGeometrie(nl.vrom.www.bag._0120.GeometrieVlak.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120","ligplaatsStatus").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setLigplaatsStatus(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setLigplaatsStatus(nl.vrom.www.bag.stuf._0120.LigplaatsStatus_type0.Factory.parse(reader));
