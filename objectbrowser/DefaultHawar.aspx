				...
				if(filterNode != null) {
					...
					foreach(System.Xml.XmlNode node in filterLayers) {
						...
						if(filterFields.length > 0) {							
							...
							// MS 2005 10 20
							//whereclause = maplayer.getSQLWhere;
							//if(whereclause.length>0){
								//maplayer.setSQLWhere("<%= node.Attributes["filter"].Value %> IN (" + filterFields + ") AND "+ whereclause.tostring());
							//}
							//else {
								//maplayer.setSQLWhere("<%= node.Attributes["filter"].Value %> IN (" + filterFields + ")");
							//}
							...
							<tr>
								<td>
									<div class="menubaritems" id="menu-layers" style="overflow: no-scroll">
										<div  style="overflow: auto;height: 400px; width=160px">
										<table width="100%">
