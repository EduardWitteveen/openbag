...
//	attachFunctionXYClick(PinPoint_AddPoint);
	//change directive in case of error
	parent.viewer.onClickAction.Value = value;
	//OnClickAction.value = value;
	//OnClickAction.value
}
...
//{
//	var MGMap = getMap();
//	var MLayerR = MGMap.getMapLayer("Pinpoint_Remark");
//	if(MLayerR == null) {
//		alert("no map with name Pinpoint_Remark");
//		return;
//	}
//	var MLayerQ = MGMap.getMapLayer("Pinpoint_Question");
//	if(MLayerQ == null) {
//		alert("no map with name Pinpoint_Question");
//		return;
//	}
//	MLayerR.setRebuild(true);
