 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for StandardObjectProperties
                        */

                        
                                    protected net.opengis.www.gml.StandardObjectProperties localStandardObjectProperties ;
                                

                           /**
                           * Auto generated getter method
                           * @return net.opengis.www.gml.StandardObjectProperties
                           */
                           public  net.opengis.www.gml.StandardObjectProperties getStandardObjectProperties(){
                               return localStandardObjectProperties;
                           }
                            ...
                            /**
                               ...
                               * @param param StandardObjectProperties
                               */
                               public void setStandardObjectProperties(net.opengis.www.gml.StandardObjectProperties param){
                            
                                            this.localStandardObjectProperties=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AbstractGMLType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AbstractGMLType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AbstractGMLType",
    ...
    public static class Factory{
        ...
        */
        public static AbstractGMLType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AbstractGMLType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AbstractGMLType)nl.vrom.www.bag.stuf._0120.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
