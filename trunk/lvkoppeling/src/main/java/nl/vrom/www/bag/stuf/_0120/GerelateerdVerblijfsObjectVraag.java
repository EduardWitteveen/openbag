...
/**
 * GerelateerdVerblijfsObjectVraag.java
 *
 ...
 */
            ...
            /**
            *  GerelateerdVerblijfsObjectVraag bean class
            */
        
        public  class GerelateerdVerblijfsObjectVraag extends nl.vrom.www.bag.stuf._0120.GerelateerdBagObjectVraag
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GerelateerdVerblijfsObjectVraag
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localGebruiksdoelVerblijfsobjectTracker = false ;
                              ...
                              */
                              public void setGebruiksdoelVerblijfsobject(nl.vrom.www.bag.stuf._0120.GebruiksdoelVerblijfsobject_type0[] param){
                                   ...
                                   validateGebruiksdoelVerblijfsobject(param);
                                          ...
                                          if (param != null){
                                             //update the setting tracker
                                             localGebruiksdoelVerblijfsobjectTracker = true;
                                          } else {
                                             localGebruiksdoelVerblijfsobjectTracker = true;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localOppervlakteVerblijfsobjectTracker = false ;
                            ...
                            /**
                               ...
                               */
                               public void setOppervlakteVerblijfsobject(nl.vrom.www.bag.stuf._0120.OppervlakteVerblijfsobject_type0 param){
                                       ...
                                       if (param != null){
                                          //update the setting tracker
                                          localOppervlakteVerblijfsobjectTracker = true;
                                       } else {
                                          localOppervlakteVerblijfsobjectTracker = true;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localVerblijfsobjectStatusTracker = false ;
                            ...
                            /**
                               ...
                               */
                               public void setVerblijfsobjectStatus(nl.vrom.www.bag.stuf._0120.VerblijfsobjectStatus_type0 param){
                                       ...
                                       if (param != null){
                                          //update the setting tracker
                                          localVerblijfsobjectStatusTracker = true;
                                       } else {
                                          localVerblijfsobjectStatusTracker = true;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GerelateerdVerblijfsObjectVraag.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GerelateerdVerblijfsObjectVraag",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GerelateerdVerblijfsObjectVraag",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.vrom.nl/bag/stuf/0120","GerelateerdVerblijfsObjectVraag"));
    ...
    public static class Factory{
        ...
        */
        public static GerelateerdVerblijfsObjectVraag parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GerelateerdVerblijfsObjectVraag object =
                new GerelateerdVerblijfsObjectVraag();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GerelateerdVerblijfsObjectVraag".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GerelateerdVerblijfsObjectVraag)nl.vrom.www.bag.stuf._0120.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list7 = new java.util.ArrayList();
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setIdentificatie(nl.vrom.www.bag.stuf._0120.Identificatie_type1.Factory.parse(reader));
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setBron(nl.vrom.www.bag.stuf._0120.Bron_type1.Factory.parse(reader));
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setGeconstateerd(nl.vrom.www.bag.stuf._0120.Geconstateerd_type1.Factory.parse(reader));
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setInOnderzoek(nl.vrom.www.bag.stuf._0120.InOnderzoek_type1.Factory.parse(reader));
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list7.add(nl.vrom.www.bag.stuf._0120.GebruiksdoelVerblijfsobject_type0.Factory.parse(reader));
                                                                }
